...
The Algebraic Color System is designed to be the "Source of Truth" for your color palette. However, we know that design happens in tools like Figma. This guide explains how to bridge the gap.

## The Workflow

1.  **Configure & Solve**: Use the [Theme Builder](/guides/theme-builder) or edit `color-config.json` to define your system.
...
```bash
pnpm color-system export --format dtcg > tokens.json
```
