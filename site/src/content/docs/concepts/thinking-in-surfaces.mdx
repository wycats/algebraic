...
description: The fundamental mental model of the Axiomatic Color.
---
...
The Axiomatic Color acts as a **Context Engine**. Instead of giving you a fixed list of colors, it gives you **Surfaces** that automatically adjust their content to fit the environment.
