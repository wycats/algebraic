...
The Algebraic Color System doesn't store a list of colors for every surface. Instead, it calculates them dynamically based on a set of boundary conditions.
...
In the Algebraic System, the solver **re-runs the physics simulation** every time you change an anchor. It guarantees that:
