...
### 3. Variable Naming Divergence (Observation)
...
- **Impact**: This is technically correct, but it highlights that the "HTML" path loses the type safety and autocomplete benefits.
- **Recommendation**: This is likely intentional, but worth noting.
